 ...
 */
package com.linj.rocketmq.temp.admin.service.client;

import com.google.common.base.Throwables;
import com.linj.rocketmq.temp.util.JsonUtil;
...
public class MQAdminExtImpl implements MQAdminExt {
    ...
    @Override
    @Deprecated //迭代中的废弃接口，start 统一入口在 MQAdminAspect 实现
    public void start() throws MQClientException {
        throw new IllegalStateException("thisMethod is deprecated.use com.linj.rocketmq.admin.aspect.MQAdminAspect instead of this");
    }

    @Override
    @Deprecated //迭代中的废弃接口
    public void shutdown() {
        throw new IllegalStateException("thisMethod is deprecated.use com.linj.rocketmq.admin.aspect.admin.MQAdminAspect instead of this");
    }
